...
```
Luego del Crossvalidation los mejores paramatros para el modelo, permitieron obtener un Recall de `r recall_score`, el cual es igual que el del modelo anterior. Por lo que el primero modelo ya tienen los mejores parametros para predecir la variable Classification.
